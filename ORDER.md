...
https://github.com/jaxassistant55/jax-micro-offer-studio/issues/6
...
Use the catalog row for Static Service Site Starter at $200, then move to the repo-specific structured form or order board for public-safe scope intake. The catalog is not payment proof. Paid work or transfer starts only after accepted scope and external payment proof through a seller-owned checkout, invoice, marketplace order, funded milestone, or payment request.
...
- Packet: https://jaxassistant55.github.io/jax-micro-offer-studio/one-sale-payment-packets.html#standalone-static-service-site-starter
- Route: Static Service Site Starter ($200)
...
- Completed `buyer-brief-template.md`.
- Business name and service area.
- Services to include.
- Approved contact or booking link.
- Approved proof, testimonials, photos, or claim limits.
- Publishing or handoff preference.

## Acceptance Checklist

- Buyer confirms all business facts and assets are authorized.
- Buyer accepts the fixed $200 scope.
...
- Final delivery includes customized HTML and handoff notes.
...
https://github.com/jaxassistant55/static-service-site-starter/issues/1
